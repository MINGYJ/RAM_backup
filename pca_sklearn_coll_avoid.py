...
def pca_draw(cari=True):
    ...
    #replace name list
    rep_word={"weighted_calc":"Modality(Mobile Money)","Hh_debt_amt":"Less Debt","calc_tobacco_total":"Tobacco","calc_tobacco_per":"Higher Percentage of Household Spent on Tobacco",
              'Number_members_been_working_last_days':"More Adults Working",
                'in_src_1st_amt':"Higher Income",'Hh_debt_amount_mnth':"Less New Debt in Last 30 Days",'calc_health_services_total':"More spend on Health Services",
