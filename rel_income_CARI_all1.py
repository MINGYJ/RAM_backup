...
def print_corr(df_copy):
    ...
    df=raw_df[["in_src_1st_amt","CARI_unrounded_ECMEN_v3_camp"]]
            ...
            for value in col_values:
                ...
                if raw_df_cp.shape[0]>30:
                    ...
                    if np.isnan(corr_value)==False:
                        ...
                        corr_df=pd.concat([corr_df,pd.DataFrame({corr_key:[corr_value,raw_df_cp.shape[0],str(cross[0]),str(cross[1])]})],axis=1)
